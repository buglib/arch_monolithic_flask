...
class TestProductsResource:
    ...
    def test_post_return_401(self, testing_app_and_client):
        _, client = testing_app_and_client
        json_data = {
        ...
        resp = client.post("/v1/products", json=json_data)
        assert resp.status_code == 401

    def test_post_return_200(self, testing_app_and_client, testing_user_and_tokens):
        _, client = testing_app_and_client
