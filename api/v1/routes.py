...
routes = [
    ...
    dict(resource=ProductsStockpile, urls=['/products/stockpile/<int:productId>'], endpoint='product_stockpile'),
    ...
    dict(resource=Settlement, urls=['/settlement'], endpoint='settlement'),
]