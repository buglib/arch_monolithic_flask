...
validators = {
    ...
    ('products', 'PUT'): {'json': {'$ref': '#/definitions/productModel'}},
...
filters = {
    ...
    ('products', 'PUT'): {200: {'headers': None, 'schema': {'type': 'object', 'example': {'status': 'done', 'message': 'Succeed to update product'}, 'properties': {'status': {'type': 'string'}, 'message': {'type': 'string'}}}}},
